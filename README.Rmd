...
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/combo_banner.gif?raw=true")
```
...
* Run a local Shiny app to rapidly label pixels based on dissimilarity thresholds (in UMAP space) to clicked points (labels are saved as .tifs as you work; [demo of app here](https://mpgranch.shinyapps.io/paint2train_sandbox/)) 
...
```
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/plot_src_image.png?raw=true")
```
...
```
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/focal_tiles_rgb.png?raw=true")
```
Generate NDVI... 
```{r, eval=FALSE}
mclapply(
...
```
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/ndvi.png?raw=true")
```
... and MSAVI values at tiles. 
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/msavi.png?raw=true")
```
...
```
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/sobel.png?raw=true")
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/neighbs.png?raw=true")
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/umap_example.png?raw=true")
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/image_select.gif?raw=true")
```

Click on a region you wish to classify and adjust the **Dissimilarity Threshold** to match the extent of the class to label. 
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/click_paint.gif?raw=true")
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/label_class.gif?raw=true")
```

Adjust the color of painted areas from the **Aesthetics Controls** drop down menu.
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/change_paint.gif?raw=true")
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/draw.gif?raw=true")
```

Change the base imagery with the controls in the upper right. 
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/base_select.gif?raw=true")
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/quantiles.gif?raw=true")
```

Click and drag to move the controls as needed.
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/move_controls.gif?raw=true")
```
...
```
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/rf_mod_output.png?raw=true")
```
