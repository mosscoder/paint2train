...
knitr::include_graphics("https://github.com/mosscoder/paint2train/blob/main/images/banner.png?raw=true")
```
...
Adjust the color of painted areas from the **Aethetics Controls** drop down menu.
```{r, echo=FALSE, out.width="100%"}
