...
* Shiny app to rapidly label pixels based on dissimilarity thresholds (in UMAP space) to clicked points (labels are saved as .tifs as you work; [demo of app here](https://mpgranch.shinyapps.io/paint2train_sandbox/)) 
